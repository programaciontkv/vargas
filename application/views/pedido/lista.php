								...
								<td align="center">
									<div class="btn-group">
										...
										?>
											...
											<a href="<?php echo base_url();?>pedido/show_ptalon/<?php echo $pedido->ped_id?>/<?php echo $permisos->opc_id?>" class="btn btn-success" title="Talon"> <span class="fa fa-bookmark-o" ></span></a>
										<?php 
										}
									...
									<a title="Facturar" href="<?php echo base_url();?>pedido_factura/nuevo/<?php echo $pedido->ped_id?>/<?php echo $opc_id?>" class="btn btn-info"> <span class="fa fa-shopping-cart"></span></a>
