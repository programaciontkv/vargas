...
<br>
                        <table class="table">
                          <tr>
                              ...
                              <td >
                                <div class="form-group <?php if (form_error('ped_ruc_cc_cliente') != '') {
                                  echo 'has-error';
                                } ?> ">
                                  <input type="text" class="form-control" name="ped_ruc_cc_cliente" id="ped_ruc_cc_cliente" value="<?php if (validation_errors() != '') {
                                    echo set_value('ped_ruc_cc_cliente');
                                  } else {
                                    echo $pedido->ped_ruc_cc_cliente;
                                  } ?>"  onchange="buscar_clientes(this)" <?php echo $readonly ?>>
                          ...
                          <tr>
                            ...
                            <td >
                              <div class="form-group <?php if (form_error('ped_nom_cliente') != '') {
                                echo 'has-error';
                              } ?> ">
                                <input type="text" class="form-control" name="ped_nom_cliente" id="ped_nom_cliente" value="<?php if (validation_errors() != '') {
                                  echo set_value('ped_nom_cliente');
                                } else {
                                  echo $pedido->ped_nom_cliente;
                                } ?>" <?php echo $readonly ?>>
                                ...
                                <input type="hidden" class="form-control" name="tipo_cliente" id="tipo_cliente" value="<?php if (validation_errors() != '') {
                                  echo set_value('tipo_cliente');
                                } else {
                                  echo $pedido->tipo_cliente;
                                } ?>" >
                              </td>
                          </tr>
                          <tr>
                            ...
                            <td >
                              <div class="form-group <?php if (form_error('ped_dir_cliente') != '') {
                                echo 'has-error';
                              } ?> ">
                                <input maxlength="80" type="text" class="form-control" name="ped_dir_cliente" id="ped_dir_cliente" value="<?php if (validation_errors() != '') {
                                  echo set_value('ped_dir_cliente');
                                } else {
                                  echo $pedido->ped_dir_cliente;
                                } ?>" <?php echo $readonly ?>>
                            ...
                            <tr>
                              ...
                              <td >
                                <div class="form-group <?php if (form_error('ped_tel_cliente') != '') {
                                  echo 'has-error';
                                } ?> ">
                                  <input type="text" class="form-control" name="ped_tel_cliente" id="ped_tel_cliente" value="<?php if (validation_errors('ped_tel_cliente') != '') {
                                    echo set_value('ped_tel_cliente');
                                  } else {
                                    echo $pedido->ped_tel_cliente;
                                  } ?>" <?php echo $readonly ?>>
                            ...
                            <tr>
                              ...
                              <td >
                                <div class="form-group <?php if (form_error('ped_email_cliente') != '') {
                                  echo 'has-error';
                                } ?> ">
                                  <input type="email" class="form-control" name="ped_email_cliente" id="ped_email_cliente" value="<?php if (validation_errors() != '') {
                                    echo set_value('ped_email_cliente');
                                  } else {
                                    echo $pedido->ped_email_cliente;
                                  } ?>" <?php echo $readonly ?>>
                            ...
                            <!-- <tr>
                              ...
                              <td >
                                <div class="form-group <?php if (form_error('ped_parroquia_cliente') != '') {
                                  echo 'has-error';
                                } ?> ">
                                  <input type="text" class="form-control" name="ped_parroquia_cliente" id="ped_parroquia_cliente" value="<?php if (validation_errors() != '') {
                                    echo set_value('ped_parroquia_cliente');
                                  } else {
                                    echo $pedido->ped_parroquia_cliente;
                                  } ?>" <?php echo $readonly ?>>
                            ...
                            <tr> -->
                              ...
                              <td >
                                <div class="form-group <?php if (form_error('ped_ciu_cliente') != '') {
                                  echo 'has-error';
                                } ?> ">
                                  <input type="text" class="form-control" name="ped_ciu_cliente" id="ped_ciu_cliente" value="<?php if (validation_errors() != '') {
                                    echo set_value('ped_ciu_cliente');
                                  } else {
                                    echo $pedido->ped_ciu_cliente;
                                  } ?>" <?php echo $readonly ?>>
                            ...
                            <tr>
                              ...
                              <td >
                                <div class="form-group <?php if (form_error('ped_pais_cliente') != '') {
                                  echo 'has-error';
                                } ?> ">
                                  <input type="text" class="form-control" name="ped_pais_cliente" id="ped_pais_cliente" value="<?php if (validation_errors() != '') {
                                    echo set_value('ped_pais_cliente');
                                  } else {
                                    echo $pedido->ped_pais_cliente;
                                  } ?>" <?php echo $readonly ?>>
                               ...
                               <table class="table ">
                                ...
                                <td class="col-md-12">
                                    ...
                                    <label>Fecha Emision:</label>
                                     ...
                                     <div class="form-group <?php if (form_error('ped_femision') != '') {
                                       echo 'has-error';
                                     } ?> ">
                                  <input type="text" class="form-control" name="ped_femision" id="ped_femision" value="<?php if (validation_errors() != '') {
                                    echo set_value('ped_femision');
                                  } else {
                                    echo $pedido->ped_femision;
                                  } ?>" readonly>
                                  <?php echo form_error("ped_femision", "<span class='help-block'>", "</span>"); ?>
                                    ...
                                    <div class="form-group <?php if (form_error('ped_fentrega') != '') {
                                      echo 'has-error';
                                    } ?> ">
                                  <input type="text" class="form-control" name="ped_fentrega" id="ped_fentrega" value="<?php if (validation_errors() != '') {
                                    echo set_value('ped_fentrega');
                                  } else {
                                    echo $pedido->ped_fentrega;
                                  } ?>" <?php echo $disabled ?>>
                                  <?php echo form_error("ped_fentrega", "<span class='help-block'>", "</span>"); ?>
                                </div>

                                  <label>Local:</label>
                                  <div class="form-group  <?php if (form_error('ped_local') != '') {
                                    echo 'has-error';
                                  } ?>" >
                                  ...
                                  <div class="form-group <?php if (form_error('ped_vendedor') != '') {
                                    echo 'has-error';
                                  } ?> "  >
